  ...
  const handlePlayerStatusChange = (teamId: number, playerIndex: number) => {
    const newTeams = teams.map(team => {
      if (team.id === teamId) {
        ...
        newPlayers[playerIndex] = newPlayers[playerIndex] === 'true' ? 'false' : 'true'
            ...
            {teams
              ...
              .sort((a, b) => {
                ...
                if (a.customPosition !== undefined) {
                  return a.customPosition - (b.customPosition || b.position || 0)
                }
                if (b.customPosition !== undefined) {
                  return (a.customPosition || a.position || 0) - b.customPosition
                }
